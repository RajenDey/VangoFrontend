	...
	constructor(app) {
		...
		this.menuContainer = $el("div.comfy-menu", {parent: document.body}, [
			...
			$el("button", {
				...
				textContent: "Save",
				onclick: () => {
					const workflowString = JSON.stringify(app.graph.serialize(), null, 2);
					const fileId = window.location.pathname.split('/').pop();
					saveFile(fileId, workflowString);
			...
			$el("button", {id: "comfy-import-button", textContent: "Import from ComfyUI", onclick: () => fileInput.click()}),
			$el("button", {
				id: "comfy-export-button",
				textContent: "Export to ComfyUI",
				onclick: () => {
